...
extension Text {
    ...
    static var testCases: [TestCase] {
        ...
        let texts: [Text] = [
            ...
            .attributed(NSAttributedString(string: " ")),
            .attributed(NSAttributedString(string: "", attributes: [.font: UIFont.helvetica(size: 42)])),
            .attributed(NSAttributedString(string: " ", attributes: [.font: UIFont.helvetica(size: 42)])),
            ...
            .attributed(NSAttributedString(string: "Hello! 😄😄😄", attributes: [.font: UIFont.helvetica(size: 42)])),
            ]
